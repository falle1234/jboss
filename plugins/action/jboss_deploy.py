...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        self._transfer_file(self._task.args['deployment_file'], tmp_remote_src + self._task.args['deployment'])
        ...
        result['temp_file'] = tmp_remote_src + self._task.args['deployment']
        return result